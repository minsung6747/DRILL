...
class DashState:
    ...
    def do(boy):
        ...
        boy.x = boy.x + boy.velocity + boy.dash 
        boy.x = clamp(25, boy.x, 800 - 25)
...
next_state_table = {
    ...
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, RIGHT_DOWN: IdleState, LEFT_DOWN: IdleState, DASH_DOWN: DashState, DASH_UP: DashState},
